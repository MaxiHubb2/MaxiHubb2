...
🎓 Estudiante de Desarrollo Web en la UNLaM  
💻 Apasionado por .NET, Java y el desarrollo full stack  
🚀 Buscando oportunidades para seguir aprendiendo y construir proyectos innovadores  

## 🛠 Tecnologías que uso  
- **Backend:** .NET (ASP.NET, Entity Framework, SignalR), Java (Spring Boot)  
